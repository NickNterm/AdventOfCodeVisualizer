...
data class AdventOfCodeSolution(val solution: String, val input: String, val day: Int)

fun solutions(day: Int): AdventOfCodeSolution {
    return AdventOfCodeSolution(
        solution = """
...
fun main() {
    fun part1(input: List<String>): Int {
        ...
        // Sort the lists. This is required cause then I am able to this is a really really really long line that i have to render on the div inside the page Sort the lists. This is required cause then I am able to this is a really really really long line that i have to render on the div inside the page
